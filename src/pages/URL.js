...
export default (props) => {
  ...
  const [values, setValues] = useState({
    message: "https://github.com/saifalamkhan373"
  });
  const url_qr_code = `https://qrcode.tec-it.com/API/QRCode?data=${values.message}&backcolor=#ffffff`;
  return (
    <>
      <Navbar />
      <Grid container>
          ...
          >
            <Box style={{ padding: 25 }}>
              ...
              <TextField
                ...
                placeholder="https://github.com/saifalamkhan373"
                fullWidth
